  ...
  return (
    <div className="animate-slide-in-up max-w-4xl mx-auto space-y-8">
      ...
      <Card>
        ...
        <div className="flex flex-col md:flex-row justify-between md:items-center p-4 bg-red-50 border-l-4 border-red-500 rounded-r-lg">
            <div>
                <p className="font-semibold text-red-800">Clear Exam Data</p>
                <p className="text-sm text-red-700 mt-1">This will permanently delete all of your past exam reports. This action cannot be undone.</p>
            </div>
