...
const Register: React.FC<RegisterProps> = ({ onRegister, onGoToLogin }) => {
  ...
  const inputStyles = "mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm";
      ...
      <Card className="w-full max-w-md animate-slide-in-up">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex flex-col items-center">
            <img src={avatarPreview} alt="Avatar Preview" className="w-24 h-24 rounded-full object-cover mb-4 border-4 border-gray-200" />
          ...
          <div>
            <label htmlFor="school" className="block text-sm font-medium text-text-secondary">School (Optional)</label>
          ...
          <div>
            <label htmlFor="learningGoals" className="block text-sm font-medium text-text-secondary">Learning Goals (Optional)</label>
